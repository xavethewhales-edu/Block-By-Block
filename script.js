...
const scenes = {
  ...
  scene1: {
    type: "text",
    text: `BLOCK BY BLOCK — WEEK 1<br><br><strong>Factory Before Site</strong><br><br>Opening discussion:<br>• Which parts of a building do you think benefit most from factory production?<br>• Which design decisions become harder to change once manufacturing starts?<br>• Is faster construction automatically better architecture?`,
    choices: [
      { text: "Start the investigation", next: "scene2_article" }
    ]
  },

  scene2_article: {
    type: "text",
    text: `ARTICLE MISSION — Modular by Design<br><br>Read selectively. Find:<br>1. one reason the manufacturer should be involved early;<br>2. two building elements that benefit from standardisation;<br>3. one area where architectural variation can still be protected.<br><br>Be ready to explain the trade-off between repeatability and design identity.`,
    choices: [
      {
        text: "Open article ↗",
        url: "https://www.modular.org/2026/08/28/modular-by-design-turning-architecture-into-a-manufacturing-system/",
        target: "_blank"
      },
      { text: "Continue after reading", next: "scene3_article_mc" }
    ]
  },
  ...
  scene3_article_mc: {
    type: "text",
    shuffleOptions: true,
    text: `According to the article, why is early manufacturer involvement especially important in modular design?`,
    choices: [
      {
        text: "Because the architect can avoid coordinating building services until the factory stage.",
        next: "scene3_retry"
      },
      {
        text: "Because factory production removes the need for site-specific design decisions.",
        next: "scene3_retry"
      },
      {
        text: "Because the design must align with real production, logistics and certification constraints before late redesign becomes expensive.",
        next: "scene4_fib"
      },
      {
        text: "Because modular projects normally require less design information than site-built projects.",
        next: "scene3_retry"
      }
    ]
  },
  ...
  scene3_retry: {
    type: "text",
    text: `Not quite. The key issue is not simply speed. The article argues that modular projects work best when architecture, manufacturing, logistics, services and assembly are coordinated early.`,
    choices: [
      { text: "Try again", next: "scene3_article_mc" }
    ]
  },
  ...
  scene4_fib: {
    ...
    sentence: [
      "Factory-based production can be",
      "__________",
      "predictable than site work because tolerances and workflows are controlled,",
      "__________",
      "site-built construction remains more exposed to weather and sequencing risk. Yet modular systems are",
      "__________",
      "flexible if major design changes are introduced after production begins."
    ],
    blanks: [1, 3, 5],
    options: [
      "whereas",
    ...
    next: "scene5_scramble"
  },

  scene5_scramble: {
    type: "scramble",
    scramble: [
      "to coordinate manufacturing, logistics and installation.",
      "the easier it becomes",
      "The earlier the design team freezes repetitive interfaces,"
    ],
    correct: [
      "The earlier the design team freezes repetitive interfaces,",
      "the easier it becomes",
  ...
  scene6_video: {
    ...
    youtube: "https://www.youtube.com/watch?v=GUJix39F5VU",
    text: `VIDEO INVESTIGATION — China's prefabricated building industry gains concrete traction globally<br><br>Watch the report and focus on the production logic: what moves into the factory, what happens in parallel, and what changes for the design team.`,
    shuffleOptions: true,

    questions: [
      {
        text: "What does the report identify as the main reason the construction cycle can be shortened so dramatically?",
        options: [
          "Robotics removes the design stage entirely.",
          "More trades are added to the site at the same time.",
          "Factory activities can happen in parallel instead of following a strictly sequential site process.",
          "Modular buildings avoid inspection and commissioning."
        ],
        correct: 2
      },
      {
        text: "Which statement best matches the production process shown in the report?",
        options: [
          "Many components are precision-fabricated in the factory and prepared for on-site installation.",
          "Only the structural frame is manufactured off-site; all finishes are completed traditionally.",
          "The factory produces raw materials, but assembly remains entirely site-based.",
          "The process depends on hand-built one-off components rather than repeatable systems."
        ],
        correct: 0
      },
      {
        text: "What important caution does the report add to the speed argument?",
        options: [
          "Fast assembly makes logistics irrelevant.",
          "Architectural coordination can be postponed until modules arrive on site.",
          "Industrialised construction works without changing conventional design practice.",
          "The design stage itself has to adapt to the industrialised construction process."
        ],
        correct: 3
      }
    ],
    ...
    endings: {
      high: "scene7_decision",
      medium: "scene7_decision",
      low: "scene6_retry"
    }
  },
  ...
  scene6_retry: {
    type: "text",
    text: `Rewatch with one question in mind: what is genuinely happening in parallel, and which decisions therefore have to be made earlier?`,
    choices: [
      {
        text: "Return to the video challenge",
        next: "scene6_video"
      }
    ]
  },
  ...
  scene7_decision: {
    type: "text",
    shuffleOptions: true,
    text: `PROFESSIONAL DECISION<br><br>A 12-storey residential block is being considered for a high level of off-site manufacture. Before supporting the strategy, which issue would you investigate first?<br><br>There is no single correct answer — defend your priority.`,
    choices: [
      {
        text: "Design freeze, interfaces and tolerance strategy",
        next: "scene7a_design"
      },
      {
        text: "Transport, crane access and installation sequence",
        next: "scene7b_logistics"
      },
      {
        text: "Code compliance, procurement responsibilities and factory/site scope",
        next: "scene7c_scope"
      }
    ]
  },
  ...
  scene7a_design: {
    type: "text",
    text: `DESIGN PRIORITY<br><br>Strong choice. Factory precision can reproduce a good solution very efficiently — but it can also reproduce an unresolved interface hundreds of times.<br><br>Discuss which decisions should be frozen early and which should remain adaptable.`,
    choices: [
      { text: "Go to Grammar Run", next: "scene8_grammar_run" }
    ]
  },

  scene7b_logistics: {
    type: "text",
    text: `LOGISTICS PRIORITY<br><br>Strong choice. A module that works perfectly in BIM still has to be transported, lifted, positioned and connected.<br><br>Discuss how module dimensions and installation sequence can influence architecture before construction starts.`,
    choices: [
      { text: "Go to Grammar Run", next: "scene8_grammar_run" }
    ]
  },
  ...
  scene7c_scope: {
    type: "text",
    text: `SCOPE PRIORITY<br><br>Strong choice. Modular delivery depends on a very clear division between factory work and site work.<br><br>Discuss what can go wrong when responsibility for services, finishes, testing or interfaces is ambiguous.`,
    choices: [
      { text: "Go to Grammar Run", next: "scene8_grammar_run" }
    ]
  },
  ...
  scene8_grammar_run: {
    ...
    text: `GRAMMAR RUN — Advanced comparison<br><br>Complete each sentence quickly. The grammar should sound natural in a professional design meeting.`,
    timerPer: 10,
    shuffle: true,
    ...
    questions: [
      {
        prompt: "Factory production can be ___ more predictable than conventional site work.",
        answers: ["considerably"],
        hint: "(nearly / considerably / considerably than)"
      },
      {
        prompt: "Site work is not nearly ___ controlled as factory production.",
        answers: ["as"],
        hint: "(than / so / as)"
      },
      {
        prompt: "The earlier repetitive interfaces are fixed, the ___ it becomes to coordinate production.",
        answers: ["easier"],
        hint: "(easiest / easier / more easy)"
      },
      {
        prompt: "Modular construction may shorten the programme, ___ it can make late changes more expensive.",
        answers: ["although"],
        hint: "(whereas / despite / although)"
      },
      {
        prompt: "A hybrid approach can preserve ___ architectural variation than a fully standardised system.",
        answers: ["more"],
        hint: "(more / most / much)"
      },
      {
        prompt: "Late design changes are often ___ more costly once factory production has started.",
        answers: ["far"],
        hint: "(far / nearly / as)"
      }
    ]
  ...
  scene8_retry: {
    type: "text",
    text: `Comparison language needs to be precise.<br><br>Watch the structures:<br>• far / considerably + comparative<br>• not nearly as ... as<br>• the earlier ... the easier`,
    choices: [
      { text: "Retry Grammar Run", next: "scene8_grammar_run" }
    ]
  },

  scene9_email: {
    type: "email",
    text: `WRITING TASK — 100–130 words<br><br>You are advising a project lead who is considering greater use of off-site manufacture on a residential building.<br><br>Recommend ONE element that is well suited to factory production and identify ONE design risk that must be resolved early.<br><br>Use at least two advanced comparison structures from today's lesson and at least four of these terms naturally:<br><br>design freeze • interface • tolerance • off-site manufacture • assembly sequence • standardisation • logistics • factory scope`,
    teacherEmail: "xavier.benitz@gmail.com",
    emailSubject: "Block by Block — Week 1: Factory Before Site",
    emailBody: "",
  ...
  scene10_email_sent: {
    type: "text",
    text: `✅ WEEK 1 WRITING COMPLETE<br><br>You have moved from “modular is faster” to the more useful architectural question: what has to be designed differently when production becomes industrialised?`,
    choices: [
      { text: "Complete Week 1", next: "thank_you_scene" }
    ]
  },
  ...
  thank_you_scene: {
    ...
    finishOnEnter: false,
    scoreRaw: 100,
    text: `BLOCK BY BLOCK — WEEK 1 COMPLETE<br><br>Factory Before Site`,
    choices: [
      { text: "Play Week 1 again", next: "scene1" }
    ]
  }
